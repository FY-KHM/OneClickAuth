								...
								<div class="panel-body">
									<div class="row">
											...
											<div class="chart-data-selector" id="salesSelectorWrapper">
												...
												<div id="salesSelectorItems" class="chart-data-selector-items mt-sm">
													...
													<script>
														...
														$gitc = DB::table('users')->where('API','github')->count();
														$fc= DB::table('users')->where('API','facebook')->count();
														$gooc= DB::table('users')->where('API','google')->count();
														$ldnc= DB::table('users')->where('API','linkedin')->count();
														$count=$count-($gitc+$fc+$gooc+$ldnc);
														?>
														var flotDashSales1Data = [{
														    data: [
														        ["Github", "<?php echo $gitc;?>"],
														        ["Facebook", "<?php echo $fc;?>"],
														        ["Google", "<?php echo $gooc;?>"],
														        ["Linkedin", "<?php echo $ldnc;?>"],
														      	["Others", "<?php echo $count;?>"]
														    ],
														    color: "#0088cc"
														}];
										...
										<div class="col-lg-4 text-center">
											<h2 class="panel-title mt-md">Number of API's</h2>
											<div class="liquid-meter-wrapper liquid-meter-sm mt-lg">
												<div class="liquid-meter">
													<meter min="0" max="100" value="35" id="meterSales"></meter>
												</div>
												<div class="liquid-meter-selector" id="meterSalesSel">
													<a href="#" data-val="28" class="active">API's Used by the user(s)</a>
												</div>
											</div>
										</div>
									</div>
